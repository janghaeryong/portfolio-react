...
const greeting = {
  ...
  message:
    'Previously a computer science senior, a web developer for my university, and founder of an AI tool for college students. Now working at IBM as a software developer.',
  basedLocation: 'Austin, TX (USA)',
  resumeLink:
    'https://drive.google.com/file/d/1BEiPuAOCQPWc1RVN5Bn_7KyxhR0HL_bv/view?usp=sharing', // recommended: google drive file share link (change to "anyone on the internet can view")
  logo: {
...
const experiences = [
  ...
  },
  {
    ...
    content: [
      {
        sectionHeader: [
          'Williamboard Project - Solo Full-Stack Developer',
          'May 2023 - July 2024',
        ],
        bulletPoints: [
    ...
    hashtags: ['Laravel', 'PHP', 'MySQL', 'JS', 'Vue.js', 'HTML', 'Tailwind'],
  },
  // {
  //     position: "Math Tutor",
  //     company: {
...
const works = [
  {
    ...
    yearCompleted: '2025',
    description:
      'Developed a tiny open-source library of highly-reusable and malleable React components (+TS logic) for LAS public domain UI AI analytics project. Sections, toggleables, drop-downs, icons, graphs.',
  ...
  },
  {
    ...
    yearCompleted: '2024',
    description:
      'Lead the backend and frontend development of a smart study tool transforming course notes into personalized practice exams and study guides.',
    techStack:
      'Vue.js, JS, HTML, Tailwind.css, FastAPI, Python, MariaDB, Docker, Llama.ai',
    links: [
      {
        label: '',
        type: 'external',
  ...
  },
  {
    ...
    yearCompleted: '2023',
    description:
      'Designed and developed an open-sourced single page application template to help web developers create visually appealing personal portfolios, focusing on ease of use and customization. Built with Vue.js, JS, HTML, Tailwind CSS, the project achieved 27 stars and 14 forks on GitHub.',
